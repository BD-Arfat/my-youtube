...
import ytLogoMobile from "../image/yt-logo-mobile (1).png";
...
const Headers = () => {
    ...
    return (
        <div draggable='true' className='sticky top-0 z-10 flex flex-row items-center justify-between h-14 px-4 md:px-5 bg-white dark:bg-black'>
            {loding && <Loader />}
            ...
            <div className='flex h-5 items-center'>
                ...
                <Link to={"/"} className='flex h-5 items-center'>
                    <img className='h-full hidden dark:md:block' src={ytLogo} alt="My youtube" />
                    <img className='h-full md:hidden' src={ytLogoMobile} alt="My youtube" />
                </Link>
