...
const VideoDetails = () => {
    ...
    const [relatedVidieos, setRelatedVieos] = useState();
    const { id } = useParams();
        ...
        <div className="flex justify-center flex-row h-[calc(100%-56px)] bg-black">
            <div className="w-full max-w-[1300px] flex flex-col lg:flex-row">
                ...
                <div className="flex flex-col lg:w[calc(100%-350px)] xl:w-[calc(100%-400px)] px-4 py-3 lg:py-6 overflow-y-auto">
                    <div className="h-[200px] md:h-[400px] lg:h-[400px] xl:h-[550px] ml-[-16px] lg:ml-0 mr-[-16px] lg:ar-0">
                        <ReactPlayer
                    ...
                    <div className="flex flex-col py-6 px-4 overflow-y-auto lg:w-[350px] xl:w-[400px]">
                            {relatedVidieos?.contents?.map((item,index)=>{
